import argparse #python library to read in arguments data['f.20002.0.3']
def parse_args(): 
    ...
    parser.add_argument("--ukbb_code",default="f.20002.0.3")
    ...
    for line in data[1::]:
        ...
        for c in columns: 
            ...
            if tokens[c] !="NA":
                ...
                patient_dict[patient][header[c]]=1
